...
def test_create_statement_interactor_with_invalid_question_id_raises_error(
    ...
    short_text = "string"
    question_id =1
    problem_statement_storage = create_autospec(ProblemStatementStorageInterface)
...
def test_create_statement_interactor_with_new_data_returns_question_id(
    ...
    problem_statement_storage.create_problem_statement.return_value = \
        question_dto
    ...
    # Assert
    problem_statement_storage.create_problem_statement.assert_called_once_with(
        user_id=user_id, short_text=short_text,
...
def test_create_statement_interactor_with_existing_question_id_returns_question_id(
    ...
    problem_statement_storage.is_valid_question_id.return_value = True
    problem_statement_storage.update_problem_statement.return_value = \
        question_dto
    presenter.get_create_problem_statement_response.return_value =\
        question_dict
    ...
    # Assert
    problem_statement_storage.update_problem_statement.assert_called_once_with(
        user_id=user_id, short_text=short_text,
