"""
Update TestCase with valid details
"""
...
class TestCase05CreateCodingQuestionTestCaseAPITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username: str, password: str):
        super(TestCase05CreateCodingQuestionTestCaseAPITestCase, self)\
