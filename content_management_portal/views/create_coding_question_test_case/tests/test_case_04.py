"""
Create New TestCase with valid details
"""
...
class TestCase04CreateCodingQuestionTestCaseAPITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username: str, password: str):
        super(TestCase04CreateCodingQuestionTestCaseAPITestCase, self)\
