"""
Create TestCase with Invalid Question Id return NotFound
"""
...
class TestCase01CreateCodingQuestionTestCaseAPITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username: str, password: str):
        super(TestCase01CreateCodingQuestionTestCaseAPITestCase, self)\
