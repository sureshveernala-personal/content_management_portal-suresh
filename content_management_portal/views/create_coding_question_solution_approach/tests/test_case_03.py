"""
Create SolutionApproach with SolutionApproach Id not belongs to Question
"""
...
class TestCase03CreateCodingQuestionSolutionApproachAPITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username: str, password: str):
        super(TestCase03CreateCodingQuestionSolutionApproachAPITestCase, self)\
