"""
Test Create PrefilledCode with invalid Question id
"""
...
class TestCase01CreateCodingQuestionPrefilledCodesAPITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username: str, password: str):
        super(TestCase01CreateCodingQuestionPrefilledCodesAPITestCase, self)\
