"""
Test Create CleanSolution with Clean Solution id not belongs to Question
"""
...
class TestCase03CreateCodingQuestionCleanSolutionsAPITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username: str, password: str):
        super(TestCase03CreateCodingQuestionCleanSolutionsAPITestCase, self)\
