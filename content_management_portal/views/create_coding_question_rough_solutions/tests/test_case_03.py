"""
Test Create RoughSolution with Rough Solution id not belongs to Question
"""
...
class TestCase03CreateCodingQuestionRoughSolutionsAPITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username: str, password: str):
        super(TestCase03CreateCodingQuestionRoughSolutionsAPITestCase, self)\
