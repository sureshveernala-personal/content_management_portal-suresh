"""
Test Update Hint with valid details
"""
...
class TestCase05CreateCodingQuestionHintAPITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username: str, password: str):
        super(TestCase05CreateCodingQuestionHintAPITestCase, self)\
