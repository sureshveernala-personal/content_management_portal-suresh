"""
Test create Hint with invalid Hint id
"""
...
class TestCase02CreateCodingQuestionHintAPITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username: str, password: str):
        super(TestCase02CreateCodingQuestionHintAPITestCase, self)\
