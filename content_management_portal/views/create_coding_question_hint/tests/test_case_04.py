"""
Test create New Hint with valid details
"""
...
class TestCase04CreateCodingQuestionHintAPITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username: str, password: str):
        super(TestCase04CreateCodingQuestionHintAPITestCase, self)\
