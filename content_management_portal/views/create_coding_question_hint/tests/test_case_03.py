"""
Test create Hint with Hint id not belongs to question
"""
...
class TestCase03CreateCodingQuestionHintAPITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username: str, password: str):
        super(TestCase03CreateCodingQuestionHintAPITestCase, self)\
