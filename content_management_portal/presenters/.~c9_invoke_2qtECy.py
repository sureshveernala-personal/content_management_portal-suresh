...
from content_management_portal.interactors.storages.dtos\
    import RoughSolutionsWithQuestionIdDto, QuestionStatusDto,\
...
class PresenterImplementation(PresenterInterface):
    ...
    def get_create_rough_solutions_response(
        ...
        rough_solution_dicts = [
            ...
            for rough_solution_dto in rough_solutions_dto_with_question_id
        ]
    ...
    def get_create_prefilled_codes_response(
        ...
        prefilled_code_dicts = [
            ...
            for prefilled_code_dto in prefilled_codes_dto_with_question_id
        ]
    ...
    def get_create_clean_solutions_response(
        ...
        clean_solution_dicts = [
            ...
            for clean_solution_dto in clean_solutions_dto_with_question_id
        ]
    ...
    def _get_rough_solution_dict(
            rough_solution: RoughSolutionsWithQuestionIdDto
        ) -> Dict:
        rough_solution_dict = {
    ...
    def _get_rough_solution_dicts_list(
            self, rough_solution_dtos: List[RoughSolutionsWithQuestionIdDto]
        ) -> List:
        rough_solution_dicts = [
            self._get_rough_solution_dict(
                rough_solution=rough_solution_dto
    ...
    def _get_prefilled_code_dict(
            prefilled_code: PrefilledCodesWithQuestionIdDto
        ) -> Dict:
        prefilled_code_dict = {
    ...
    def _get_prefilled_code_dicts_list(
            self, prefilled_code_dtos: List[PrefilledCodesWithQuestionIdDto]
        ):
        prefilled_code_dicts = [
    ...
    def _get_clean_solution_dict(
            clean_solution: CleanSolutionsWithQuestionIdDto
        ) -> Dict:
        clean_solution_dict = {
    ...
    def _get_clean_solution_dicts_list(
            self, clean_solution_dtos: List[CleanSolutionsWithQuestionIdDto]
        ):
        clean_solution_dicts = [
