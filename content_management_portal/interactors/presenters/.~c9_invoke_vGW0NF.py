...
from content_management_portal.interactors.storages.dtos\
    import QuestionsDto, TestCaseWithQuestionIdDto, QuestionDto, \
    PrefilledCodesWithQuestionIdDto, CleanSolutionsWithQuestionIdDto,\
...
class PresenterInterface(ABC):
    ...
    def get_create_rough_solutions_response(
            ...
            List[RoughSolutionsWithQuestionIdDto]
        ):
        pass
