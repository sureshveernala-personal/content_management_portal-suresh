...
class CreateSolutionsInteractor(QuestionValidationMixin):
    ...
    def create_solutions_wrapper(
            self, question_id: str, solution_dtos: List,
            presenter: PresenterInterface
        ):
        try:
            clean_solutions_dto = self.create_solutions(
    ...
    def create_solutions(
        ...
        solution_dtos_list = self._get_clean_solutions_dtos_list(
            clean_solutions
        )
