...
class CreateSolutionApproachInteractor:
    ...
    def create_solution_approach(
            self, question_id: int, solution_approach_details: Dict
        ):
        solution_approach_id = solution_approach_details[
            'solution_approach_id'
        ]
        self._validate_question_id(question_id=question_id)

        solution_approach_dto = self.\
            _convert_solution_approach_dict_to_solution_approach_dto(
        ...
        if is_update:
            ...
            try:
                ...
                self.presenter.raise_can_not_create_more_then_one_question()
    ...
    def _convert_solution_approach_dict_to_solution_approach_dto(
        ...
        solution_approach_dto = SolutionApproachDto(
            ...
            complexity_analysis_content_type=complexity_analysis[
                'content_type'
            ]
        )
    ...
    def _validate_solution_approach(
            self, solution_approach_id: int, question_id: int
        ):
